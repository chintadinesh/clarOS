...
#define GPIO_PORTD4 (*((volatile uint32_t *)0x40007040))
...
int main(void) {
  ...
  GPIO_PORTD_DIR_R |= 0x1E;     // make PD4-1 out
  GPIO_PORTD_AFSEL_R &= ~0x1E;  // disable alt funct on PD4-1
  GPIO_PORTD_DEN_R |= 0x1E;     // enable digital I/O on PD4-1
                                // configure PD4-1 as GPIO
  GPIO_PORTD_PCTL_R = (GPIO_PORTD_PCTL_R & 0xFFF0000F) + 0x00000000;
  GPIO_PORTD_AMSEL_R &= ~0x1E;  // disable analog functionality on PD3-1
