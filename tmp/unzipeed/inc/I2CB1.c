...
void I2C0_Init(uint32_t I2Cfreq, uint32_t busFreq) {
  ...
  //  I2C0_MCR_R = I2C_MCR_MFE|I2C_MCR_GFE;             // 9) master function
  //  enable, glitch I2C0_MCR2_R = I2C_MCR2_GFPW_4; // 4 clock glitch
...
int I2C0_Send4(uint8_t slaveAddr, uint8_t data1, uint8_t data2, uint8_t data3,
               uint8_t data4) {
  while (I2C0_MCS_R & I2C_MCS_BUSY) {
  };                              // wait for I2C ready
  I2C0_MSA_R = (slaveAddr << 1);  // MSA[7:1] is slave address
