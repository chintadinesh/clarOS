...
// TxD (output of this microcontroller) interrupts and FIFO used for receiver,
// busy-wait on transmit. Daniel Valvano Jan 3, 2020
...
uint32_t UART1_InStatus(void) { return ((RxPutI - RxGetI) & (FIFOSIZE - 1)); }
