...
int main(void) {       // use this with motor board version 5
  ...
  SteeringMode = 0;
  Servo_Init(25000, Steering);
  Left_Init(12500, Power,
            0);  // left wheel low power, forward, initialize PWM0, 100 Hz
  Right_Init(12500, 12500 - Power,
             1);  // right wheel low power, forward, initialize PWM0, 100 Hz
