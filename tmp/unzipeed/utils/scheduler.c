...
//
//*****************************************************************************
void SchedulerSysTickIntHandler(void) { g_ui32SchedulerTickCount++; }
...
void SchedulerTaskEnable(uint32_t ui32Index, bool bRunNow) {
  ...
  if (ui32Index < g_ui32SchedulerNumTasks) {
    ...
    if (bRunNow) {
      ...
      //
      g_psSchedulerTable[ui32Index].ui32LastCall = g_ui32SchedulerTickCount;
    }
  }
}
...
//
//*****************************************************************************
uint32_t SchedulerTickCountGet(void) { return (g_ui32SchedulerTickCount); }
...
//
//*****************************************************************************
uint32_t SchedulerElapsedTicksCalc(uint32_t ui32TickStart,
                                   uint32_t ui32TickEnd) {
  return ((ui32TickEnd > ui32TickStart)
              ? (ui32TickEnd - ui32TickStart)
