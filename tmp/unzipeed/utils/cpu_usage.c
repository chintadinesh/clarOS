...
//
//*****************************************************************************
static uint32_t g_pui32CPUUsageTimerBase[6] = {TIMER0_BASE, TIMER1_BASE,
...
uint32_t CPUUsageTick(void) {
  ...
  //
  ui32Value =
      MAP_TimerValueGet(g_pui32CPUUsageTimerBase[g_ui32CPUUsageTimer], TIMER_A);
  ...
  //
  ui32Usage =
      ((((g_ui32CPUUsagePrevious - ui32Value) * 6400) / g_ui32CPUUsageTicks) *
       1024);
...
//
//*****************************************************************************
void CPUUsageInit(uint32_t ui32ClockRate, uint32_t ui32Rate,
                  uint32_t ui32Timer) {
  //
  // Check the arguments.
  //
