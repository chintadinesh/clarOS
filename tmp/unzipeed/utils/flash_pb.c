...
//
//*****************************************************************************
static uint32_t FlashPBIsValid(uint8_t *pui8Offset) {
...
//
//*****************************************************************************
void FlashPBSave(uint8_t *pui8Buffer) {
  uint8_t *pui8New;
  uint32_t ui32Idx, ui32Sum;
...
//
//*****************************************************************************
void FlashPBInit(uint32_t ui32Start, uint32_t ui32End, uint32_t ui32Size) {
