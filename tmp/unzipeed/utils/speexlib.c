...
//
//*****************************************************************************
int32_t SpeexDecodeFrameSizeGet(void) {
  int iFrameSize;
  ...
  //
  speex_decoder_ctl(g_sSpeexDecoder.pvState, SPEEX_GET_FRAME_SIZE, &iFrameSize);
...
//
//*****************************************************************************
int32_t SpeexDecode(uint8_t *pui8InBuffer, uint32_t ui32InSize,
  ...
  //
  i32Bytes = speex_decode_int(g_sSpeexDecoder.pvState, &g_sSpeexDecoder.sBits,
...
//
//*****************************************************************************
int32_t SpeexEncodeQualitySet(int iQuality) {
  //
...
//
//*****************************************************************************
int32_t SpeexEncodeFrameSizeGet(void) {
  int iFrameSize;
  ...
  //
  speex_encoder_ctl(g_sSpeexEncoder.pvState, SPEEX_GET_FRAME_SIZE, &iFrameSize);
...
//
//*****************************************************************************
int32_t SpeexEncodeInit(int iSampleRate, int iComplexity, int iQuality) {
...
//
//*****************************************************************************
int32_t SpeexEncode(int16_t *pui16InBuffer, uint32_t ui32InSize,
                    uint8_t *pui8OutBuffer, uint32_t ui32OutSize) {
  int32_t i32Bytes;
...
//
//*****************************************************************************
void _speex_fatal(const int8_t *str, const int8_t *file, int line) {
  ASSERT(0);
  while (1) {
  }
}
