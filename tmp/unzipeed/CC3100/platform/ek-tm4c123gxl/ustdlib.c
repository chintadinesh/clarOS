...
//
//*****************************************************************************
static const time_t g_psDaysToMonth[12] = {0,   31,  59,  90,  120, 151,
...
//
//*****************************************************************************
unsigned long ustrtoul(const char *restrict nptr, const char **restrict endptr,
                       int base) {
...
static const float g_pfExponents[] = {
    1.0e+01, 1.0e+02, 1.0e+04, 1.0e+08, 1.0e+16, 1.0e+32,
};
...
//
//*****************************************************************************
void usrand(unsigned int seed) { g_iRandomSeed = seed; }
