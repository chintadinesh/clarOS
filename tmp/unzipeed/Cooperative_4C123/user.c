...
//   Each thread rapidly toggles a pin on profile pins and increments its
//   counter THREADFREQ is the rate of the scheduler in Hz
...
int main(void) {
  ...
  OS_Launch(BSP_Clock_GetFreq() /
            THREADFREQ);  // doesn't return, interrupts enabled in here
