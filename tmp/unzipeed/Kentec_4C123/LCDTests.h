...
const unsigned char testSprite4BPP[] = {
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFE, 0xDC, 0xBA, 0x98,
    0x76, 0x54, 0x32, 0x1F, 0xF1, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF,
    0xFE, 0xDC, 0xBA, 0x98, 0x76, 0x54, 0x32, 0x1F, 0xF1, 0x23, 0x45, 0x67,
    0x89, 0xAB, 0xCD, 0xEF, 0xFE, 0xDC, 0xBA, 0x98, 0x76, 0x54, 0x32, 0x1F,
    0xF1, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF, 0xFE, 0xDC, 0xBA, 0x98,
    0x76, 0x54, 0x32, 0x1F, 0xF1, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF,
    0xFE, 0xDC, 0xBA, 0x98, 0x76, 0x54, 0x32, 0x1F, 0xF1, 0x23, 0x45, 0x67,
    0x89, 0xAB, 0xCD, 0xEF, 0xFE, 0xDC, 0xBA, 0x98, 0x76, 0x54, 0x32, 0x1F,
    0xF1, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF, 0xFE, 0xDC, 0xBA, 0x98,
...
void TestStringOutput() {
  LCD_SetCursor(0, 0);
  LCD_PrintString(
      "This is just a test string, please ignore.\nI repeat, this is just a "
      "test string, please ignore.");
}

void RandomRectangles() {
  LCD_DrawRect(
      Random() % 200, Random() % 160, Random() % 160, Random() % 100,
      convertColor(Random() % 3 * 127, Random() % 3 * 127, Random() % 3 * 127));
}
...
void RandomCircle() {
  LCD_DrawFilledCircle(Random() % 280 + 20, Random() % 200 + 20, 20,
                       Random() % 0xFFFF);
}
