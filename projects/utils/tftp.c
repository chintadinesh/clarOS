...
//
//*****************************************************************************
static void TFTPErrorSend(tTFTPConnection *psTFTP, tTFTPError eError) {
  uint32_t ui32Length;
  uint8_t *pui8Data;
  struct pbuf *p;
...
//
//*****************************************************************************
static void TFTPDataSend(tTFTPConnection *psTFTP) {
  uint32_t ui32Length;
  uint8_t *pui8Data;
  tTFTPError eError;
  struct pbuf *p;
...
//
//*****************************************************************************
static void TFTPDataAck(tTFTPConnection *psTFTP) {
  uint8_t *pui8Data;
  struct pbuf *p;
...
//
//*****************************************************************************
static void TFTPDataRecv(void *arg, struct udp_pcb *upcb, struct pbuf *p,
...
//
//*****************************************************************************
static tTFTPMode TFTPModeGet(uint8_t *pui8Request, uint32_t ui32Len) {
...
//
//*****************************************************************************
static void TFTPRecv(void *arg, struct udp_pcb *upcb, struct pbuf *p,
                     struct ip_addr *addr, u16_t port) {
  uint8_t *pui8Data;
  bool bGetRequest;
  tTFTPMode eMode;
  ...
  if (eMode != TFTP_MODE_INVALID) {
    ...
    //
    eRetcode =
        g_pfnRequest(psTFTP, bGetRequest, (int8_t *)(pui8Data + 2), eMode);
