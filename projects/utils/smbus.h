...
extern void SMBusARPUDIDPacketEncode(tSMBusUDID *pUDID, uint8_t ui8Address,
                                     uint8_t *pui8Data);
extern void SMBusARPUDIDPacketDecode(tSMBusUDID *pUDID, uint8_t *pui8Address,
                                     uint8_t *pui8Data);
...
extern tSMBusStatus SMBusMasterProcessCall(tSMBus *psSMBus,
                                           ...
                                           uint8_t *pui8TxData,
                                           uint8_t *pui8RxData);
extern tSMBusStatus SMBusMasterBlockProcessCall(
    tSMBus *psSMBus, uint8_t ui8TargetAddress, uint8_t ui8Command,
...
extern tSMBusStatus SMBusMasterI2CRead(tSMBus *psSMBus,
                                       uint8_t ui8TargetAddress,
                                       uint8_t *pui8Data, uint8_t ui8Size);
extern tSMBusStatus SMBusMasterI2CWriteRead(
    tSMBus *psSMBus, uint8_t ui8TargetAddress, uint8_t *pui8TxData,
    uint8_t ui8TxSize, uint8_t *pui8RxData, uint8_t ui8RxSize);
