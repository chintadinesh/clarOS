...
//
//*****************************************************************************
#define SOFTUART_CONFIG_WLEN_MASK 0x00000060  // Mask for extracting word length
...
#define SOFTUART_CONFIG_STOP_MASK 0x00000008  // Mask for extracting stop bits
#define SOFTUART_CONFIG_STOP_ONE 0x00000000   // One stop bit
#define SOFTUART_CONFIG_STOP_TWO 0x00000008   // Two stop bits
#define SOFTUART_CONFIG_PAR_MASK 0x00000086   // Mask for extracting parity
#define SOFTUART_CONFIG_PAR_NONE 0x00000000   // No parity
#define SOFTUART_CONFIG_PAR_EVEN 0x00000006   // Even parity
#define SOFTUART_CONFIG_PAR_ODD 0x00000002    // Odd parity
#define SOFTUART_CONFIG_PAR_ONE 0x00000082    // Parity bit is one
#define SOFTUART_CONFIG_PAR_ZERO 0x00000086   // Parity bit is zero
...
extern bool SoftUARTCharPutNonBlocking(tSoftUART *psUART, uint8_t ui8Data);
