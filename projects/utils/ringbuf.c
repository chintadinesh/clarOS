...
//
//*****************************************************************************
static void UpdateIndexAtomic(volatile uint32_t *pui32Val, uint32_t ui32Delta,
                              uint32_t ui32Size) {
  bool bIntsOff;
...
bool RingBufFull(tRingBufObject *psRingBuf) {
  ...
  //
  return ((((ui32Write + 1) % psRingBuf->ui32Size) == ui32Read) ? true : false);
}
...
//
//*****************************************************************************
void RingBufRead(tRingBufObject *psRingBuf, uint8_t *pui8Data,
                 uint32_t ui32Length) {
  uint32_t ui32Temp;
...
void RingBufAdvanceRead(tRingBufObject *psRingBuf, uint32_t ui32NumBytes) {
  ...
  //
  UpdateIndexAtomic(&psRingBuf->ui32ReadIndex, ui32Count, psRingBuf->ui32Size);
}
...
//
//*****************************************************************************
void RingBufWrite(tRingBufObject *psRingBuf, uint8_t *pui8Data,
                  uint32_t ui32Length) {
  uint32_t ui32Temp;
...
//
//*****************************************************************************
void RingBufInit(tRingBufObject *psRingBuf, uint8_t *pui8Buf,
                 uint32_t ui32Size) {
  //
  // Check the arguments.
  //
