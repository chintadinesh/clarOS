 ...
 * @return 0 if everything is ok, non-zero in case of error (e.g. invalid
 * pointer or trying to unallocate memory that has already been unallocated)
 * @brief  Free memory
 */
 ...
 * @param  reference to a heap_stats_t that returns the current usage of the
 * heap
 * @return 0 in case of success, non-zeror in case of error (e.g. corrupted
 * heap)
