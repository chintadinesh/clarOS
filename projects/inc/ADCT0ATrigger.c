...
#define TIMER_CFG_16_BIT \
  0x00000004                               // 16-bit timer configuration,
                                           // function is controlled by bits
                                           // 1:0 of GPTMTAMR and GPTMTBMR
#define TIMER_TAMR_TACDIR 0x00000010       // GPTM Timer A Count Direction
#define TIMER_TAMR_TAMR_PERIOD 0x00000002  // Periodic Timer mode
#define TIMER_CTL_TAOTE \
  0x00000020                       // GPTM TimerA Output Trigger
                                   // Enable
...
#define TIMER_TAILR_TAILRL_M \
  0x0000FFFF  // GPTM TimerA Interval Load
              // Register Low
...
int ADC0_InitTimer0ATriggerSeq0(uint32_t channelNum, uint32_t fs,
                                void (*task)(uint32_t)) {
  ...
  switch (channelNum) {  // 1) activate clock
    ...
    case 11:  //    these are on GPIO_PORTB
      ...
      break;
    default:
      return 0;  //    0 to 11 are valid channels on the LM4F120
  }
