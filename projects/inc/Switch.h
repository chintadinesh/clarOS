...
// PF4 connected to a negative logic switch using internal pull-up (trigger on
// both edges) Initialize switch interface on PF4 Inputs:  pointer to a function
// to call on touch (falling edge),
