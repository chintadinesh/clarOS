...
unsigned short const Color4[16] = {
    ...
    ((0x00 >> 3) << 11) | ((0x00 >> 2) << 5) |
        (0xAA >> 3),  // 1 – blue                    (#0000AA) 	000001 	1
    ((0x00 >> 3) << 11) | ((0xAA >> 2) << 5) |
        (0x00 >> 3),  // 2 – green                   (#00AA00) 	000010 	2
    ((0x00 >> 3) << 11) | ((0xAA >> 2) << 5) |
        (0xAA >> 3),  // 3 – cyan                    (#00AAAA) 	000011 	3
    ((0xAA >> 3) << 11) | ((0x00 >> 2) << 5) |
        (0x00 >> 3),  // 4 – red                     (#AA0000) 	000100 	4
    ((0xAA >> 3) << 11) | ((0x00 >> 2) << 5) |
        (0xAA >> 3),  // 5 – magenta                 (#AA00AA) 	000101 	5
    ((0xAA >> 3) << 11) | ((0x55 >> 2) << 5) |
        (0x00 >> 3),  // 6 – brown                   (#AA5500) 	010100 	20
    ((0xAA >> 3) << 11) | ((0xAA >> 2) << 5) |
        (0xAA >> 3),  // 7 – white / light gray      (#AAAAAA) 	000111 	7
    ((0x55 >> 3) << 11) | ((0x55 >> 2) << 5) |
        (0x55 >> 3),  // 8 – dark gray /bright black (#555555) 	111000 	56
    ((0x55 >> 3) << 11) | ((0x55 >> 2) << 5) |
        (0xFF >> 3),  // 9 – bright blue             (#5555FF) 	111001 	57
    ((0x55 >> 3) << 11) | ((0xFF >> 2) << 5) |
        (0x55 >> 3),  // 10 – bright green           (#55FF55) 	111010 	58
    ((0x55 >> 3) << 11) | ((0xFF >> 2) << 5) |
        (0xFF >> 3),  // 11 – bright cyan            (#55FFFF) 	111011 	59
    ((0xFF >> 3) << 11) | ((0x55 >> 2) << 5) |
        (0x55 >> 3),  // 12 – bright red             (#FF5555) 	111100 	60
    ((0xFF >> 3) << 11) | ((0x55 >> 2) << 5) |
        (0xFF >> 3),  // 13 – bright magenta         (#FF55FF) 	111101 	61
    ((0xFF >> 3) << 11) | ((0xFF >> 2) << 5) |
        (0x55 >> 3),  // 14 – bright yellow          (#FFFF55) 	111110 	62
    ((0xFF >> 3) << 11) | ((0xFF >> 2) << 5) |
        (0xFF >> 3)  // 15 – bright white           (#FFFFFF) 	111111 	63
};
...
//#define CONVERT24BPP(c) ( (((c) & 0x00f80000) >> 8) | (((c) & 0x0000fc00) >>
// 5) | (((c) & 0x000000f8) >> 3) )
#define CONVERT24BPP(c) \
  ((((c)&0x00f80000) >> 8) | (((c)&0x0000fc00) >> 5) | (((c)&0x000000f8) >> 3))
...
void LCD_Init(void) {
  ...
  LCD_WriteCommand(SSD2119_LCD_DRIVE_AC_CTRL_REG);  // 0x30EF = 0,0 in bottom
                                                    // right, scan left
...
void LCD_DrawBMP(const unsigned char* imgPtr, unsigned short x,
  ...
  for (i = 0; i < height; i++) {
    ...
    switch (bpp) {
      ...
      case 24: {  // seems to work
        for (j = 0; j < width; j++) {
          // read 24bit RGB value into pixelData
          unsigned long pixelData = *(pixelOffset) | *(pixelOffset + 1) << 8 |
                                    *(pixelOffset + 2) << 16;
