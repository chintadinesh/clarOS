...
// Motor board version 6 with DRV8848 dual H-bridge
void DRV8848_RightInit(uint16_t period, uint16_t duty,
  ...
  if (direction == COAST) {
    ...
    Right_Init(period, period - duty,
               1);  // PB6 is negative logic duty, PB7 is 1
  } else {
    Right_InitB(period, period - duty,
                1);  // PB7 is negative logic duty, PB6 is 1
  }
}
...
// Motor board version 6 with DRV8848 dual H-bridge
void DRV8848_LeftInit(uint16_t period, uint16_t duty,
                      enum Direction direction) {
  ...
  if (direction == COAST) {
    ...
    Left_InitB(period, period - duty,
               1);  // PB5 is negative logic duty, PB4 is 1
  } else {
    Left_Init(period, period - duty,
              1);  // PB4 is negative logic duty, PB5 is 1
  }
}
