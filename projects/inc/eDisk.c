...
//   ms, 80 MHz clock TIMER5_TAPR_R = 0;               // 5) bus clock
//   resolution TIMER5_ICR_R = 0x00000001;       // 6) clear timer5A timeout
//   flag TIMER5_IMR_R = 0x00000001;       // 7) arm timeout interrupt
